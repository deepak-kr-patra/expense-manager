    ...
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="mt-2 lg:mt-8 flex items-center justify-between gap-2">
                ...
                <button onClick={() => toggleAddPendingExpenseModal()} className="flex h-10 items-center rounded-lg bg-blue-600 px-4 text-sm font-medium text-white transition-colors hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
